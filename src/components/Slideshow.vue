...
const projects = [
	...
	},
	{
		...
		description:
			'i got to work with three companies at once thanks to my school, collaborating with 3 other students to make this website for the Italian artist "Lorenzo Vannini"'
	},
	{
		...
		description:
			"small project to scan the internet for minecraft servers, really fun to visit random people's servers"
	},
	{
		name: 'OpenCloud',
		image: opencloudImg,
...
onMounted(() => {
	document.querySelectorAll('.vueperslides__arrow svg').forEach((e) => {
		//@ts-ignore
